...
router
  .route('/')
  .get(getAuth('auth'), controller.authLists)
  .post(getAuth('auth'), controller.create);
 ...
 *  update status
 * **/
 .patch(getAuth('auth'), controller.status)
...
.get(getAuth('auth'), controller.get)
  /**
  * update the single location
  * */
.patch(getAuth('auth'), controller.update)
...
/**
 ...
 .delete(getAuth('auth'),deletes3Object, controller.remove);
